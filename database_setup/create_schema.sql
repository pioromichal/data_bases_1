...
CREATE TABLE Machines (
    ...
    CONSTRAINT chk_machines_status CHECK (status IN ('ACTIVE', 'INACTIVE', 'MAINTENANCE', 'SCRAPED', 'UNKNOWN', 'WAITING_FOR_SERVICE'))
);
...
CREATE TABLE Machines_History (
    ...
    CONSTRAINT chk_machine_history_status CHECK (new_state IN ('ACTIVE', 'INACTIVE', 'MAINTENANCE', 'SCRAPED', 'UNKNOWN', 'WAITING_FOR_SERVICE')),
    FOREIGN KEY (machine_id) REFERENCES Machines(machine_id),

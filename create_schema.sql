...
BEGIN
    ...
    names := namesarray('Machine_History', 'Services', 'Products', 'Employees', 'Machines', 'Positions', 'Production_Line', 'Machine_Type');
...
CREATE TABLE Machine_History (
    ...
    FOREIGN KEY (machine_id) REFERENCES Machines(machine_id),
    FOREIGN KEY (new_production_line_id) REFERENCES Production_Line(production_line_id)
);
